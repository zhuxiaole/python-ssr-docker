...
ADD UDPSPEEDER_MODE_COMPROMISE.sh /UDPSPEEDER_MODE_COMPROMISE.sh
ADD UDPSPEEDER_MODE_GAME.sh /UDPSPEEDER_MODE_GAME.sh
ADD UDPSPEEDER_MODE_GAME_NO_LIMIT.sh /UDPSPEEDER_MODE_GAME_NO_LIMIT.sh
ADD UDPSPEEDER_MODE_NORMAL.sh /UDPSPEEDER_MODE_NORMAL.sh
RUN chmod a+x /*.sh
